...
SOURCEFILES_QUOTED_IF_SPACED=../common/clock.c ../common/flash.c ../common/gpio.c ../common/irq.c ../common/uart.c ../common/system.c ../common/cp0.c main.c initialize.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1270477542/clock.o ${OBJECTDIR}/_ext/1270477542/flash.o ${OBJECTDIR}/_ext/1270477542/gpio.o ${OBJECTDIR}/_ext/1270477542/irq.o ${OBJECTDIR}/_ext/1270477542/uart.o ${OBJECTDIR}/_ext/1270477542/system.o ${OBJECTDIR}/_ext/1270477542/cp0.o ${OBJECTDIR}/main.o ${OBJECTDIR}/initialize.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1270477542/clock.o.d ${OBJECTDIR}/_ext/1270477542/flash.o.d ${OBJECTDIR}/_ext/1270477542/gpio.o.d ${OBJECTDIR}/_ext/1270477542/irq.o.d ${OBJECTDIR}/_ext/1270477542/uart.o.d ${OBJECTDIR}/_ext/1270477542/system.o.d ${OBJECTDIR}/_ext/1270477542/cp0.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/initialize.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1270477542/clock.o ${OBJECTDIR}/_ext/1270477542/flash.o ${OBJECTDIR}/_ext/1270477542/gpio.o ${OBJECTDIR}/_ext/1270477542/irq.o ${OBJECTDIR}/_ext/1270477542/uart.o ${OBJECTDIR}/_ext/1270477542/system.o ${OBJECTDIR}/_ext/1270477542/cp0.o ${OBJECTDIR}/main.o ${OBJECTDIR}/initialize.o

# Source Files
SOURCEFILES=../common/clock.c ../common/flash.c ../common/gpio.c ../common/irq.c ../common/uart.c ../common/system.c ../common/cp0.c main.c initialize.c
...
MP_LINKER_FILE_OPTION=,--script="btl.ld"
# ------------------------------------------------------------------------------------
...
${OBJECTDIR}/_ext/1270477542/flash.o: ../common/flash.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1270477542" 
	@${RM} ${OBJECTDIR}/_ext/1270477542/flash.o.d 
	@${RM} ${OBJECTDIR}/_ext/1270477542/flash.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1270477542/flash.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD4=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -Werror -MMD -MF "${OBJECTDIR}/_ext/1270477542/flash.o.d" -o ${OBJECTDIR}/_ext/1270477542/flash.o ../common/flash.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/bootloader.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    btl.ld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_ICD4=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/bootloader.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x37F   -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_ICD4=1,--defsym=_min_heap_size=64960,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp=${DFP_DIR}
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/bootloader.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   btl.ld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/bootloader.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=64960,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp=${DFP_DIR}
